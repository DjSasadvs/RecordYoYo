 ...
 * 2016-01-25
 */
public class BackUpActivity extends AppCompatActivity implements GestureDetector.OnGestureListener {
    ...
    private void init() {
        mToolbar = (Toolbar) findViewById(R.id.toolbar_back_up_activity);
        mToolbar.setTitle("");
