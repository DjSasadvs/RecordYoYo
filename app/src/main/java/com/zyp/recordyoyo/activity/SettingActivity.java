...
public class SettingActivity extends AppCompatActivity implements GestureDetector.OnGestureListener {
    ...
    private void init() {
        mToolbar = (Toolbar) findViewById(R.id.toolbar_setting_activity);
        mToolbar.setTitle("");
